...
//' @description
 ...
 )
 {
   ...
   int no_of_factors = min_no_factors, no_of_obs = data.cols(), cutoff = std::floor(double(no_of_obs) / 2.);
   ...
   while (p_value < confidence_threshold && no_of_factors < max_no_factors)
   {
